...
const ImportTransactionCsvModal: FC<Props> = ({
  lang,
  isModalOpen,
  onSubmit,
  onClose,
  ...
  return (
    <Modal isOpen={isModalOpen} onClose={onClose}>
      ...
      <div className="p-5 bg-gray-800 rounded w-96 bg-opacity-40">
        {i18n.transactionCsvFormatI18n[lang]}
      </div>
      <p className="my-2">sample.csv</p>
      <div className="p-5 bg-gray-800 rounded w-96 bg-opacity-40">
        player_acc1,3162,ronin:xxxxxxxxxx...
        player_acc2,1581,ronin:xxxxxxxxxx...
        player_acc3,790,ronin:xxxxxxxxxx...
      </div>
...
export default ImportTransactionCsvModal;
